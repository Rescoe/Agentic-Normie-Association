...
export default async function AssemblyPage() {
  const t = await getTranslations("assemblyPage");
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-sm font-bold">
                      {sessionActive   ? t("sessionOpen")  :
                       sessionResolved ? t("sessionClosed") :
                       t("sessionPending")}
                    </span>
                  </div>
                </div>
                ...
                {contractsDeployed && (
                  <div className="flex gap-6 border-t border-[--border] pt-4">
                    <div>
                      ...
                      <p className="font-mono text-xs text-[--fg-muted]">{t("members")}</p>
                    </div>
                    {sessionId > 0 && (
                      <div>
