export const ConstituentAssemblyAbi = [
  ...
  { "inputs": [{ "internalType": "uint256", "name": "voterTokenId", "type": "uint256" }, { "internalType": "bytes32", "name": "role", "type": "bytes32" }], "name": "AlreadyVotedForRole", "type": "error" },
  { "inputs": [{ "internalType": "address", "name": "caller", "type": "address" }, { "internalType": "address", "name": "expected", "type": "address" }], "name": "CallerNotVoterOwner", "type": "error" },
  { "inputs": [{ "internalType": "uint256", "name": "tokenId", "type": "uint256" }], "name": "CandidateNotMember", "type": "error" },
  { "inputs": [], "name": "InvalidCore", "type": "error" },
  { "inputs": [], "name": "NoActiveSession", "type": "error" },
  { "inputs": [{ "internalType": "address", "name": "caller", "type": "address" }], "name": "NotRelayer", "type": "error" },
  { "inputs": [{ "internalType": "address", "name": "owner", "type": "address" }], "name": "OwnableInvalidOwner", "type": "error" },
  { "inputs": [{ "internalType": "address", "name": "account", "type": "address" }], "name": "OwnableUnauthorizedAccount", "type": "error" },
  { "inputs": [{ "internalType": "bytes32", "name": "role", "type": "bytes32" }], "name": "RoleNotElectable", "type": "error" },
  { "inputs": [], "name": "SessionActiveCannotChangeRoles", "type": "error" },
